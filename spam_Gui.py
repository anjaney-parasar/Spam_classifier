...
* Try putting texts like "click here to win cash" or  
"you have been selected for a 3000$ lottery" or a greeting  
**Note** Since the dataset used is not large,  
the predictions might not always be accurate''')
